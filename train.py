...
""" Training routine for 3D object detection with SUN RGB-D or ScanNet or 3RScan.
...
if FLAGS.dataset == '3rscan':
    ...
    TRAIN_DATASET = RIO(True, '/media/jingsong/5ebd8121-a4eb-43b3-b486-532a6238f6cf/', 20000, False)
...
DATASET_CONFIG = None # just for compile errors
# ------------------------------------------------------------------------- GLOBAL CONFIG END
...
def train_one_epoch():
    ...
    for batch_idx, batch_data_label in enumerate(TRAIN_DATALOADER):
        ...
        if (batch_idx+1) % batch_interval == 0:
            writer.add_scalars('train', {key:stat_dict[key]/batch_interval for key in stat_dict}, (EPOCH_CNT*len(TRAIN_DATALOADER)+batch_idx)*BATCH_SIZE)
...
def evaluate_one_epoch():
    ...
    # Log statistics
    #writer.add_scalars('eval', {key:stat_dict[key]/float(batch_idx+1) for key in stat_dict},
